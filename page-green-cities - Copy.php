...
get_header(); ?>
        ...
        <?php endif; ?>
        <!-- Project Blurb -->
        <?php if ( !empty($project_title = get_field('project_title'))) :  ?>
            ...
            <div class="container">
                <div class="row project-content">
                    <div class="col-md-7 col-sm-10 center-col text-center text-med">
                        ...
                        <p class="wow"><?php echo get_field('project_description'); ?></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <?php 
        	...
        	while ( !empty($project_image = get_field('project_image_'.$i))) : ?>
